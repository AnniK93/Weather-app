...
forecast.forEach(function(forecastDay, index) {
 ...
 `<div class="col-2">
    <div class="weather-forecast-date"><strong>${formatDay(forecastDay.dt)}</strong></div>
       <img src="http://openweathermap.org/img/wn/${forecastDay.weather[0].icon}@2x.png" alt="${forecastDay.weather[0].description}" width="42"/>
       <div class="weather-forecast-temperatures">
       <span class="weather-forecast-temperature-max"><strong>${Math.round(forecastDay.temp.max)}°F</strong></span> /
...
forecast.forEach(function(forecastHour, index) {
 ...
 `<div class="col-2">
    <div class="weather-forecast-date"><strong>${formatHour(forecastHour.dt)}:00</strong></div>
       <img src="http://openweathermap.org/img/wn/${forecastHour.weather[0].icon}@2x.png" alt="${forecastHour.weather[0].description}" width="42"/>
       <div class="weather-forecast-temperatures">
       <span class="weather-forecast-temperature"><strong>${Math.round(forecastHour.temp)}°F</strong></span>
       </div>
  </div>`;
}
});
